...
public class MentoriaTest {
    ...
    public void createMentoria(){
        ...
        assertMentoriaValues(mentoria, "titulo","descricao", Conteudo.Nivel.INICIANTE,2,0, false, LocalDate.of(2022,11,30));
    }
    @Test
    public void editMentoria(){
        Mentoria mentoria = new Mentoria("titulo","descricao", Conteudo.Nivel.INICIANTE,2, LocalDate.of(2022,11,30));

        mentoria.setCompleto(true);
        mentoria.setPercentual(100);
        ...
        assertMentoriaValues(mentoria, "titulo do mentoria","descricao do mentoria", Conteudo.Nivel.INTERMEDIARIO,5,100, true, LocalDate.of(2022,11,15));
    }
    public static void assertMentoriaValues(Mentoria mentoria,
        ...
        Assertions.assertEquals(percentual, mentoria.getPercentual());
        Assertions.assertEquals(isCompleto, mentoria.isCompleto());
